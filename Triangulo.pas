...
var
  ...
  p2: TVetor;
  p3: TVetor;
  p1X, p1Y, p1Z, p2X, p2Y, p2Z, p3X, p3Y, p3Z: double;
...
function TTriangulo.getZP1: double;
begin
  Result := p1[2];
end;

function TTriangulo.getZP2: double;
begin
  Result := p2[2];
end;

function TTriangulo.getZP3: double;
begin
  Result := p3[2];
end;
...
procedure TTriangulo.setP1Z(value: double);
begin
  p1[2] := value;
end;
...
procedure TTriangulo.setP2Z(value: double);
begin
  p2[2] := value;
end;
...
procedure TTriangulo.setP3Z(value: double);
begin
  p3[2] := value;
end;
